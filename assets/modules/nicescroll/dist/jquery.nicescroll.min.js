    ...
    w = function() {
      ...
      return (
        ...
        (i.hastransform =
          ...
          (function() {
            for (
              var e = ['msTransform', 'webkitTransform', 'MozTransform', 'OTransform'], t = 0, r = e.length;
              t < r;
              t++
            )
              if (void 0 !== o[e[t]]) {
        ...
        i.hastransform &&
          ((o[i.trstyle] = 'translate3d(1px,2px,3px)'), (i.hastranslate3d = /translate3d/.test(o[i.trstyle]))),
      ...
      function k(e, o, t) {
        ...
        return (
          ...
          o &&
            ...
            ((r = i),
            (i = 0),
            t && (r < 0 ? T.getScrollLeft() >= T.page.maxw : T.getScrollLeft() <= 0) && ((i = r), (r = 0))),
          T.isrtlmode && (r = -r),
        ...
        (this.getScrollTop = function() {
          ...
          (this.setScrollLeft = function(e) {
            return setTimeout(function() {
              if (T)
                return (
                  T.hasreversehr && (e = T.detected.ismozilla ? -(T.page.maxw - e) : T.page.maxw - e),
        ...
        (this.updateScrollBar = function(e) {
          ...
          if (T.ishwscroll)
            ...
            if (
              ...
              T.zoom &&
                T.zoom.css({ top: o.top + 1, left: 1 == T.rail.align ? o.left - 20 : o.left + T.rail.width + 4 }),
          ...
          if (
            ...
            if (
              ...
              P.isios &&
                ...
                M.disableoutline &&
                  (P.isie && T.win.attr('hideFocus', 'true'), P.iswebkit && T.win.css('outline', 'none'));
            }
            if (
              (!1 === M.autohidemode
                ? ((T.autohidedom = !1),
              ...
              (T.ontouchstart = function(e) {
                ...
                if (
                  ((T.hasmoving = !1), T.scrollmom.timer && (T.triggerScrollEnd(), T.scrollmom.stop()), !T.railslocked)
                ) {
                  var o = T.getTarget(e);
              ...
              (T.ontouchmove = function(e, o) {
                ...
                if (2 == T.rail.drag.pt) {
                  ...
                  if (T.ishwscroll && M.bouncescroll)
                    d < 0
                      ? (d = Math.round(d / 2))
                      : d > T.page.maxh && (d = T.page.maxh + Math.round((d - T.page.maxh) / 2));
                  else if (
                    (d < 0 ? ((d = 0), (s = 0)) : d > T.page.maxh && ((d = T.page.maxh), (s = 0)),
                    0 === s && !T.hasmoving)
                  )
                  ...
                  return (
                    ...
                    T.rail.drag.dl &&
                      ('v' == T.rail.drag.dl ? (u = T.rail.drag.sl) : 'h' == T.rail.drag.dl && (d = T.rail.drag.st)),
            ...
            if (
              ((T.onmousedown = function(e, o) {
                if (!T.rail.drag || 1 == T.rail.drag.pt) {
                  ...
                  T.cancelScroll(),
                    (T.rail.drag = { x: e.clientX, y: e.clientY, sx: T.scroll.x, sy: T.scroll.y, pt: 1, hr: o || !1 });
                  var t = T.getTarget(e);
                  return (
                  ...
                  (T.observerremover = new m(function(e) {
                    e.forEach(function(e) {
                      if (e.removedNodes.length > 0)
                        for (var o in e.removedNodes) if (T && e.removedNodes[o] === R) return T.remove();
                    });
                  })),
        ...
        (this.undelegate = function(e, o, t, r, i) {
          ...
          if (s && s.l)
            for (var n = 0, l = s.l.length; n < l; n++)
              s.a[n] === T.id &&
                (s.a.splice(n), s.l.splice(n), 0 === s.a.length && (T._unbind(e, o, s.l.f), (d[o] = null)));
        }),
            ...
            (this.doScrollPos = function(e, o, t) {
              ...
              if (
                ...
                (T.bouncescroll && T.railh.visibility) ||
                  (e < 0 ? ((e = 0), (s = !0)) : e > T.page.maxw && ((e = T.page.maxw), (s = !0))),
      ...
      (this.doScrollBy = function(e, o) {
        ...
        (this.doZoomIn = function(e) {
          if (!T.zoomactive) {
            ...
            return (
              ('' === n || /transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test(n)) &&
