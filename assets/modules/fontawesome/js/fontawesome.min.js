...
!(function() {
  ...
  var I = H[u],
    ...
    Y = !1;
  c &&
    ((Y = (d.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(d.readyState)) ||
  ...
  function q() {
    for (var t = 12, e = ''; 0 < t--; ) e += X[(62 * Math.random()) | 0];
    return e;
  }
  function U(t) {
  ...
  (_t.prototype = Object.create(Error.prototype)).constructor = _t;
  ...
  function Qt(t, e) {
    ...
    } else if (t && e && !T.showMissingIcons) throw new _t('Icon is missing for prefix ' + e + ' with icon name ' + t);
    return r;
  }
  function Zt(t) {
    var e,
          ...
          var l = ct.begin('onTree'),
            f = s.reduce(function(t, e) {
              try {
                ...
                w || (t instanceof _t && console.error(t));
              }
              return t;
            }, []);
          l(),
