!(function(e, t) {
  ...
  function D(e, t) {
    ...
    for (s in t)
      o(t, s) &&
        (n(e[s]) && n(t[s]) ? ((i[s] = {}), u(i[s], e[s]), u(i[s], t[s])) : null != t[s] ? (i[s] = t[s]) : delete i[s]);
  ...
  function Q(e, t, n, s, i) {
    ...
    return (
      o <= 0 ? (a = V((r = e - 1)) + o) : o > V(e) ? ((r = e + 1), (a = o - V(e))) : ((r = e), (a = o)),
      { year: r, dayOfYear: a }
    );
  }
  function X(e, t, n) {
        ...
        : 'object' == typeof a &&
          ...
          ((r = (function(e, t) {
            ...
            (t = Ye(t, e)),
              e.isBefore(t)
                ? (n = Pe(e, t))
                : (((n = Pe(t, e)).milliseconds = -n.milliseconds), (n.months = -n.months));
            return n;
          })(pe(a.from), pe(a.to))),
          ((a = {}).ms = r.milliseconds),
          (a.M = r.months)),
  ...
  function Re(e, t) {
    ...
    return (
      (n = t - i < 0 ? (t - i) / (i - e.clone().add(s - 1, 'months')) : (t - i) / (e.clone().add(s + 1, 'months') - i)),
      -(s + n) || 0
    );
  }
  function Ce(e) {
          ...
          r !== t &&
            (!n || this._changeInProgress
              ...
              : this._changeInProgress ||
                ((this._changeInProgress = !0), e.updateOffset(this, !0), (this._changeInProgress = null))),
          this
        );
      }
  ...
  return (
    ...
    (jn.as = function(e) {
      ...
      if ('month' === (e = O(e)) || 'year' === e)
        return (t = this._days + s / 864e5), (n = this._months + Ze(t)), 'month' === e ? n : n / 12;
