                ...
                for (var b = a, k = l; b < t.length; k += t[b].length, ++b) {
                  ...
                  if (!(w instanceof s)) {
                    ...
                    if (!_ && m && b != t.length - 1) {
                      ...
                      for (
                        var A = _.index + (d ? _[1].length : 0), j = _.index + _[0].length, x = b, O = k, N = t.length;
          ...
          (Prism.languages.DFS(i, function(i, e, r) {
            n.indexOf(r) > -1 &&
              ...
              'attr-value' == r
                ...
                : e.inside['url-link']
                ? Prism.languages.insertBefore('inside', 'url-link', { 'data-uri': a }, e)
                : (e.inside['data-uri'] = a));
          }),
          (i['data-uri'] = a));
      },
  ...
  if ('undefined' != typeof self && self.Prism && self.document) {
    ...
    if (!o) {
      ...
      (e.onload = function() {
        ...
        (e.src = 'https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/1.7.1/clipboard.min.js'),
        n.appendChild(e);
    }
